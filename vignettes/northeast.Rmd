...
```{r, getVisdataset, message=FALSE, warning=FALSE}
...
calib_trans <- translate_taxa(calib_dialect, pol_table ,id_cols = colnames(calib_dialect)[1:10])
...
```{r}
prep_input(veg = veg_trans, 
           pollen = calib_trans, target_taxa = target_taxa)
```
